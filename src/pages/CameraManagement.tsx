...
export const CameraManagement: React.FC = () => {
  const { customers, cameraAccounts, addCameraAccount, updateCameraAccount, deleteCameraAccount, currentUser, addCustomer } = useAppContext();
                  ...
                  <div className="relative">
                    ...
                    {isEditing && showSuggestions && activeSearchField === 'name' && (
                      <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-xl z-50 overflow-hidden max-h-[200px] overflow-y-auto">
                        ...
                        <div 
                          className="px-4 py-2.5 bg-slate-50 hover:bg-emerald-50 cursor-pointer text-slate-500 font-bold text-xs flex items-center gap-1"
                          onClick={() => {
                            setCustomerId('');
                            setShowSuggestions(false);
                          }}
                        >
                          ...
                          <span className="text-emerald-600 font-black">{customerName}</span>
                        </div>
                      </div>
                    )}
                  </div>
                      ...
                      {isEditing && showSuggestions && activeSearchField === 'phone' && (
                        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-xl z-50 overflow-hidden max-h-[200px] overflow-y-auto">
                          ...
                          >
                            ...
                            <span className="text-emerald-600 font-black">{customerPhone}</span>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-[12px] font-bold text-slate-700">
                        ...
                        {!customerId && customerName && (
                          <span className="text-[10px] text-emerald-600 font-bold ml-1 block">(Sẽ tạo tự động)</span>
                        )}
                      </div>
                    </div>
                    <div>
